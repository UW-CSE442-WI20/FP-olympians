...
function createRanking(sport) {
  ...
  var index = entriesBySportThenCountryThenYear.findIndex(function(s) {
    return s.key == sport;
  });

  var currSportOnly = entriesBySportThenCountryThenYear[index];
  console.log("heres the result", currSportOnly);
